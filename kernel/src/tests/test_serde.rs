// This file was created because I was trying to make tests for kernel types, but didn't realize that
// I was calling all arca types from the kernel types module. I re-made a different file for kernel types,
// but cleaned this up and left it here. Currently commenting this out because while they are passing locally,
// they are failing the clippy check and I dont want to change anything in /arca/ in order to fix it.
// Leaving everything here for now.
